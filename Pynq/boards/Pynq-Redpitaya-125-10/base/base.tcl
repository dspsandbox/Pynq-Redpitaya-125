...
if { $list_projs eq "" } {
   ...
   set_property BOARD_PART redpitaya.com:redpitaya-125-10:part0:1.0 [current_project]
}
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_ctrl/S_AXI/Reg] SEG_led_ctrl_Reg
