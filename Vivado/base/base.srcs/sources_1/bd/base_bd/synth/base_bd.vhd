...
--Date        : Sun Dec  6 00:31:02 2020
--Host        : 5CD010B25T running 64-bit major release  (build 9200)
--Command     : generate_target base_bd.bd
--Design      : base_bd
...
entity base_bd is
  ...
  attribute CORE_GENERATION_INFO of base_bd : entity is "base_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=base_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=8,synth_mode=Global}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of base_bd : entity is "base_bd.hwdef";
end base_bd;

architecture STRUCTURE of base_bd is
  component base_bd_processing_system7_0_0 is
  port (
  ...
  end component base_bd_processing_system7_0_0;
...
begin
processing_system7_0: component base_bd_processing_system7_0_0
     port map (
